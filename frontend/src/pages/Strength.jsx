...
function Strength() {
  ...
  const workouts = [

    {
      ...
      benefit: "Build lower body strength & improve stamina",
...

    {
      ...
      benefit: "Improves flexibility & tones muscles gently",

      img:
        "https://www.beatxp.com/blog/wp-content/uploads/2022/07/benefits-of-resistance-bands-beatxp-1200x900.jpg",
...

    {
      ...
      benefit: "Supports hormonal balance & posture",

      img:
        "https://images.unsplash.com/photo-1517960413843-0aee8e2b3285?q=80&w=1974&auto=format&fit=crop",
  ...
  useEffect(() => {
    ...
    if (timeLeft === 0 && started) {
      ...
      alert("Strength Session Completed 🎉");
  ...
  return (
    ...
    <div className="min-h-screen bg-[#14142b] text-white p-10 overflow-hidden relative">
      ...
      <p className="text-center text-gray-400 max-w-2xl mx-auto mb-16 text-lg leading-8">
        Build body strength, improve balance,
        and support wellness naturally ✨
      </p>
      ...
      {selectedWorkout && (
        ...
        <div className="mt-20 bg-white/5 border border-white/10 rounded-3xl p-10 backdrop-blur-xl shadow-2xl">
          ...
          <p className="text-center text-gray-400 mt-4 text-lg">
            Focus on your strength and wellness journey 🌿
          </p>
          ...
          <div className="mt-10 max-w-3xl mx-auto bg-white/5 border border-white/10 rounded-3xl p-8">
            ...
            <iframe
              ...
              src={
              selectedWorkout.name === "Squats"
              ? "https://www.youtube.com/embed/tgbNymZ7vqY"
              : selectedWorkout.name === "Resistance Bands"
