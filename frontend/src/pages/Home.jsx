...
// PROFESSIONAL LUNESSA HOME WITH WORKING SAKHI CHATBOT 💖
  ...
  const features = [
    {
      title: "Diet Plans",
      desc:
        "Healthy meal plans for hormonal balance",
      path: "/diet",
    },
    {
      title: "Exercise",
      desc:
        "Hormone-friendly workouts & yoga",
      path: "/exercise",
    },
    {
      title: "PCOD Care",
      desc:
        "Understand symptoms & management",
      path: "/pcod",
    },
    {
      title: "PCOS Care",
      desc:
        "Lifestyle solutions for better health",
      path: "/pcos",
    },
  ];
        ...
        {openChat && (
          ...
          <div className="w-[370px] h-[600px] bg-[#0b0b1f] border border-white/10 rounded-[35px] shadow-2xl overflow-hidden backdrop-blur-2xl flex flex-col mb-5">
            ...
            <div className="p-4 border-t border-white/10 flex gap-3">
              ...
              <button
                onClick={sendMessage}
                className="bg-gradient-to-r from-pink-500 to-purple-500 px-5 rounded-full hover:scale-110 transition flex items-center justify-center"
              >
